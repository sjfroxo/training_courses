<div class="card">
    <a href="{{ route('userStudyMain.show', ['id' => $course->id]) }}" class="text-decoration-none d-flex align-items-center" style="color: #000;">
        <div class="card-body">
            ...
            @if(auth()->user()->isUser())
                <a class="text-truncate btn btn-primary mt-2"
